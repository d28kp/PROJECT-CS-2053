...
func _on_lives_changed(new_lives):
	match new_lives:
		2:
			lives_label.text = "LIVES: ❤️❤️"
		1:
			lives_label.text = "LIVES: ❤️"
		0:
...
func _on_spawn_timer_timeout():
	...
	match edge:
		0:
			ball.position = Vector2(randf_range(50, 1230), -40)
		1:
			ball.position = Vector2(-40, randf_range(100, 680))
		2:
			ball.position = Vector2(1320, randf_range(100, 680))
